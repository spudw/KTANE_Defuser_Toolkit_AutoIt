...
Func _SimonSays_UI_Create()
	...
	GUICtrlSetOnEvent(-1, "_SimonSays_EventHandler")
	$aSimonSaysUI[$idBtnSimonSaysBLUE] = _SimonSays_UI_Create_Button("&BLUE", 353, 109, 81, 33, 0x0000FF, 0xFFFFFF)
	$aSimonSaysUI[$idBtnSimonSaysRED] = _SimonSays_UI_Create_Button("&RED", 308, 149, 81, 33, 0xFF0000, 0xFFFFFF)
	$aSimonSaysUI[$idBtnSimonSaysYELLOW] = _SimonSays_UI_Create_Button("&YELLOW", 401, 149, 81, 33, 0xFFFF00)
	$aSimonSaysUI[$idBtnSimonSaysGREEN] = _SimonSays_UI_Create_Button("&GREEN", 353, 189, 81, 33, 0x008000, 0xFFFFFF)
