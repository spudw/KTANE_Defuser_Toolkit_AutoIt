...
This tool automates and simplfies many of the aspects the experts need to help aid with defusal instructions.  Sinc all of the answers are provided to the experts, this tool doesn't provide anything that an expert couldn't do with paper and pencil.  In some cases it significantly simplifies the process, which may reduce the overall quality of the experience for the players.  
