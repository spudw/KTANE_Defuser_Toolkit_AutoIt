...
Func _TheButton_UI_Create()
	...
	$aTheButtonUI[$idGrpTheButton] = GUICtrlCreateGroup($THEBUTTON_MSG_GROUP_DEFAULT, 64, 94, 481, 195, -1, $WS_EX_TRANSPARENT)
	GUICtrlSetFont(-1, 11, 400, 0, "Calibri")
	GUICtrlSetBkColor(-1, 0xFFFFFF)
	$aTheButtonUI[$idBtnTheButtonColorWHITE] = _TheButton_UI_Create_Button("&WHITE", 124, 119, 81, 33, 0xFFFFFF, 0x000000)
	$aTheButtonUI[$idBtnTheButtonColorBLUE] = _TheButton_UI_Create_Button("&BLUE", 124, 159, 81, 33, 0x0000FF, 0xFFFFFF)
	$aTheButtonUI[$idBtnTheButtonColorYELLOW] = _TheButton_UI_Create_Button("&YELLOW", 124, 199, 81, 33, 0xFFFF00)
	$aTheButtonUI[$idBtnTheButtonColorRED] = _TheButton_UI_Create_Button("&RED", 124, 239, 81, 33, 0xFF0000, 0xFFFFFF)
	$aTheButtonUI[$idBtnTheButtonTextPRESS] = _TheButton_UI_Create_Button("&PRESS", 404, 119, 81, 33)
	$aTheButtonUI[$idBtnTheButtonTextHOLD] = _TheButton_UI_Create_Button("&HOLD", 404, 159, 81, 33)
	$aTheButtonUI[$idBtnTheButtonTextDETONATE] = _TheButton_UI_Create_Button("&DETONATE", 404, 199, 81, 33)
	$aTheButtonUI[$idBtnTheButtonTextABORT] = _TheButton_UI_Create_Button("&ABORT", 404, 239, 81, 33)
	$aTheButtonUI[$idBtnTheButtonIndicatorBLUE] = _TheButton_UI_Create_Button("&BLUE", 268, 143, 81, 33, 0x0000FF, 0xFFFFFF)
	GUICtrlSetState(-1, $GUI_HIDE)
	$aTheButtonUI[$idBtnTheButtonIndicatorYELLOW] = _TheButton_UI_Create_Button("&YELLOW", 268, 183, 81, 33, 0xFFFF00)
	GUICtrlSetState(-1, $GUI_HIDE)
	$aTheButtonUI[$idBtnTheButtonIndicatorOTHER] = _TheButton_UI_Create_Button("&OTHER", 268, 223, 81, 33)
	GUICtrlSetState(-1, $GUI_HIDE)
	GUICtrlCreateGroup("", -99, -99, 1, 1)
	$aTheButtonUI[$idLblTheButtonSolution] = GUICtrlCreateLabel("", 94, 303, 431, 57, $SS_CENTER)
	GUICtrlSetFont(-1, 16, 400, 4, "Calibri")
	GUICtrlSetBkColor(-1, 0xFFFFFF)
	$aTheButtonUI[$idBtnTheButtonReset] = _TheButton_UI_Create_Button("Reset (Esc)", 504, 48, 73, 25)
...
Func _TheButton_Show_Indicator_Buttons($iState = $GUI_SHOW)
	...
	If $iState = $GUI_SHOW Then
		_TheButton_Set_Group_MSG($THEBUTTON_MSG_INDICATOR_COLOR)
