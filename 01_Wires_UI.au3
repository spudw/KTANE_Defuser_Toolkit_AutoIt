...
Func _Wires_UI_Create()
	...
	GUICtrlCreateGroup("Enter the Wire Colors in Order from Top to Bottom", 164, 136, 481, 67, -1, $WS_EX_TRANSPARENT)
	GUICtrlSetFont(-1, 11, 400, 0, "Calibri")
	$aWiresUI[$idBtnWiresRED] = _Wires_UI_Create_Button("&RED", 184, 160, 81, 33, 0xFF0000, 0xFFFFFF)
	$aWiresUI[$idBtnWiresBLUE] = _Wires_UI_Create_Button("&BLUE", 275, 160, 81, 33, 0x0000FF, 0xFFFFFF)
	$aWiresUI[$idBtnWiresYELLOW] = _Wires_UI_Create_Button("&YELLOW", 365, 160, 81, 33, 0xFFFF00)
	$aWiresUI[$idBtnWiresWHITE] = _Wires_UI_Create_Button("&WHITE", 454, 160, 81, 33, 0xFFFFFF)
	$aWiresUI[$idBtnWiresBLACK] = _Wires_UI_Create_Button("BLAC&K", 544, 160, 81, 33, 0x000000, 0xFFFFFF)
	GUICtrlCreateGroup("", -99, -99, 1, 1)
	$aWiresUI[$idLblWiresSerialQuestion] = GUICtrlCreateLabel("Is the last digit of the Serial Number Odd?", 228, 226, 262, 22)
	GUICtrlSetFont(-1, 11, 400, 0, "Calibri")
	GUICtrlSetBkColor(-1, 0xFFFFFF)
	GUICtrlSetState(-1, $GUI_HIDE)
	$aWiresUI[$idBtnWiresSerialQuestionYes] = _Wires_UI_Create_Button("Y&es", 500, 223, 49, 25)
	GUICtrlSetState(-1, $GUI_HIDE)
	$aWiresUI[$idBtnWiresSerialQuestionNo] = _Wires_UI_Create_Button("&No", 556, 223, 49, 25)
	GUICtrlSetState(-1, $GUI_HIDE)
	$aWiresUI[$idBtnWiresReset] = _Wires_UI_Create_Button("Reset (Esc)", 700, 48, 73, 25)
	$aWiresUI[$idLblWiresSolution] = GUICtrlCreateLabel("Solution Text", 164, 261, 481, 37, $SS_CENTER)
	GUICtrlSetFont(-1, 20, 400, 4, "Calibri")
	GUICtrlSetBkColor(-1, 0xFFFFFF)
	GUICtrlSetState(-1, $GUI_HIDE)
	$aWiresUI[$idLblWiresCount] = GUICtrlCreateLabel($WIRES_MSG_COUNT & "0", 164, 106, 481, 20, $SS_CENTER)
