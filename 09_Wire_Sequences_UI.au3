...
Func _WireSequences_UI_Create()
	...
	GUICtrlCreateGroup("Enter the Wire Colors and Connection Points", 164, 80, 481, 147, -1, $WS_EX_TRANSPARENT)
	GUICtrlSetFont(-1, 11, 400, 0, "Calibri")
	GUICtrlSetBkColor(-1, 0xFFFFFF)
	$aWireSequencesUI[$idBtnWireSequencesRED] = GUICtrlCreateButton("&RED", 272, 104, 81, 33)
	GUICtrlSetOnEvent(-1, "_WireSequences_EventHandler")
	GUICtrlSetColor(-1, 0xFFFFFF)
	GUICtrlSetBkColor(-1, 0xFF0000)
	GUICtrlSetCursor(-1, 0)
	$aWireSequencesUI[$idBtnWireSequencesBLUE] = GUICtrlCreateButton("B&LUE", 272, 144, 81, 33)
	GUICtrlSetOnEvent(-1, "_WireSequences_EventHandler")
	GUICtrlSetColor(-1, 0xFFFFFF)
	GUICtrlSetBkColor(-1, 0x0000FF)
	GUICtrlSetCursor(-1, 0)
	$aWireSequencesUI[$idBtnWireSequencesBLACK] = GUICtrlCreateButton("BLAC&K", 272, 184, 81, 33)
	GUICtrlSetOnEvent(-1, "_WireSequences_EventHandler")
	GUICtrlSetColor(-1, 0xFFFFFF)
	GUICtrlSetBkColor(-1, 0x000000)
	GUICtrlSetCursor(-1, 0)
	$aWireSequencesUI[$idBtnWireSequencesA] = GUICtrlCreateButton("&A", 456, 104, 81, 33)
	GUICtrlSetOnEvent(-1, "_WireSequences_EventHandler")
	GUICtrlSetCursor(-1, 0)
	$aWireSequencesUI[$idBtnWireSequencesB] = GUICtrlCreateButton("&B", 456, 144, 81, 33)
	GUICtrlSetOnEvent(-1, "_WireSequences_EventHandler")
	GUICtrlSetCursor(-1, 0)
	$aWireSequencesUI[$idBtnWireSequencesC] = GUICtrlCreateButton("&C", 456, 184, 81, 33)
	GUICtrlSetOnEvent(-1, "_WireSequences_EventHandler")
	GUICtrlSetCursor(-1, 0)
	GUICtrlCreateGroup("", -99, -99, 1, 1)
	$aWireSequencesUI[$idBtnWireSequencesReset] = GUICtrlCreateButton("Reset (Esc)", 700, 48, 73, 25)
	GUICtrlSetOnEvent(-1, "_WireSequences_EventHandler")
	GUICtrlSetCursor(-1, 0)
	$aWireSequencesUI[$idLblWireSequencesSolution] = GUICtrlCreateLabel("", 164, 228, 481, 37, $SS_CENTER)
	GUICtrlSetFont(-1, 20, 400, 4, "Calibri")
	GUICtrlSetBkColor(-1, 0xFFFFFF)
	GUICtrlCreateGroup("Tally", 164, 260, 481, 140, -1, $WS_EX_TRANSPARENT)
	GUICtrlSetFont(-1, 11, 400, 0, "Calibri")
	GUICtrlSetBkColor(-1, 0xFFFFFF)
	$aWireSequencesUI[$idListViewWireSequences] = GUICtrlCreateListView("Wire Occurence|Action", 228, 280, 370, 110, BitOR($LVS_REPORT, $LVS_NOSORTHEADER))
