...
Func _Wires_UI_Create()
	...
	$aWiresUI[$idBtnWiresRED] = GUICtrlCreateButton("&RED", 84, 160, 81, 33)
	GUICtrlSetOnEvent(-1, "_Wires_EventHandler")
	GUICtrlSetColor(-1, 0xFFFFFF)
	GUICtrlSetBkColor(-1, 0xFF0000)
	GUICtrlSetCursor(-1, 0)
	$aWiresUI[$idBtnWiresBLUE] = GUICtrlCreateButton("&BLUE", 175, 160, 81, 33)
	GUICtrlSetOnEvent(-1, "_Wires_EventHandler")
	GUICtrlSetColor(-1, 0xFFFFFF)
	GUICtrlSetBkColor(-1, 0x0000FF)
	GUICtrlSetCursor(-1, 0)
	$aWiresUI[$idBtnWiresYELLOW] = GUICtrlCreateButton("&YELLOW", 265, 160, 81, 33)
	GUICtrlSetOnEvent(-1, "_Wires_EventHandler")
	GUICtrlSetBkColor(-1, 0xFFFF00)
	GUICtrlSetCursor(-1, 0)
	$aWiresUI[$idBtnWiresBLACK] = GUICtrlCreateButton("BLAC&K", 444, 160, 81, 33)
	GUICtrlSetOnEvent(-1, "_Wires_EventHandler")
	GUICtrlSetColor(-1, 0xFFFFFF)
	GUICtrlSetBkColor(-1, 0x000000)
	GUICtrlSetCursor(-1, 0)
	$aWiresUI[$idBtnWiresWHITE] = GUICtrlCreateButton("&WHITE", 354, 160, 81, 33)
	GUICtrlSetOnEvent(-1, "_Wires_EventHandler")
	GUICtrlSetBkColor(-1, 0xFFFFFF)
	GUICtrlSetCursor(-1, 0)
	...
	$aWiresUI[$idBtnWiresSerialQuestionYes] = GUICtrlCreateButton("Y&es", 400, 223, 49, 25)
	GUICtrlSetOnEvent(-1, "_Wires_EventHandler")
	GUICtrlSetCursor(-1, 0)
	GUICtrlSetState(-1, $GUI_HIDE)
	$aWiresUI[$idBtnWiresSerialQuestionNo] = GUICtrlCreateButton("&No", 456, 223, 49, 25)
	GUICtrlSetOnEvent(-1, "_Wires_EventHandler")
	GUICtrlSetCursor(-1, 0)
	GUICtrlSetState(-1, $GUI_HIDE)
	$aWiresUI[$idBtnWiresReset] = GUICtrlCreateButton("Reset (Esc)", 504, 48, 73, 25)
	GUICtrlSetOnEvent(-1, "_Wires_EventHandler")
	GUICtrlSetCursor(-1, 0)
