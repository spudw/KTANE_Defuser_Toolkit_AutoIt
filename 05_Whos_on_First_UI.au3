...
Func _WhosOnFirst_UI_Create()
	...
	GUICtrlCreateGroup("Select the Display Word, then Select the Word in the Key Location", 164, 72, 481, 251, -1, $WS_EX_TRANSPARENT)
	GUICtrlSetFont(-1, 11, 400, 0, "Calibri")
	GUICtrlSetBkColor(-1, 0xFFFFFF)
	GUICtrlCreateLabel("Key Location Word", 477, 92, 152, 27, $SS_CENTER)
	GUICtrlSetFont(-1, 14, 800, 0, "Calibri")
	$aWhosOnFirstUI[$idListWhosOnFirstDisplayWords] = GUICtrlCreateList("", 188, 120, 137, 186, $WS_VSCROLL)
	GUICtrlSetOnEvent(-1, "_WhosOnFirst_EventHandler")
	$aWhosOnFirstUI[$idListWhosOnFirstKeyWords] = GUICtrlCreateList("", 484, 120, 137, 186, $WS_VSCROLL)
	GUICtrlSetOnEvent(-1, "_WhosOnFirst_EventHandler")
	GUICtrlCreateLabel("Keyword Location", 341, 168, 128, 23, $SS_CENTER)
	GUICtrlSetFont(-1, 12, 800, 0, "Calibri")
	$aWhosOnFirstUI[$idLblWhosOnFirstKeywordLocation] = GUICtrlCreateLabel("", 341, 192, 128, 30, $SS_CENTER)
	GUICtrlSetFont(-1, 16, 800, 0, "Calibri")
	GUICtrlCreateLabel("Display Words", 198, 93, 118, 27, $SS_CENTER)
	GUICtrlSetFont(-1, 14, 800, 0, "Calibri")
	GUICtrlSetBkColor(-1, 0xFFFFFF)
	GUICtrlCreateGroup("", -99, -99, 1, 1)
	$aWhosOnFirstUI[$idBtnModeulNameReset] = GUICtrlCreateButton("Reset (Esc)", 700, 48, 73, 25)
	GUICtrlSetOnEvent(-1, "_WhosOnFirst_EventHandler")
	GUICtrlSetCursor (-1, 0)
	GUICtrlCreateGroup("Have the Defuser Click the Button of the First Word that appears in the list below", 164, 328, 481, 73)
	GUICtrlSetFont(-1, 11, 400, 0, "Calibri")
	GUICtrlSetBkColor(-1, 0xFFFFFF)
	$aWhosOnFirstUI[$idLblWhosOnFirstWordList] = GUICtrlCreateLabel("", 200, 352, 412, 48, $SS_CENTER)
	GUICtrlSetFont(-1, 12, 800, 0, "Calibri")
	GUICtrlCreateGroup("", -99, -99, 1, 1)
EndFunc
