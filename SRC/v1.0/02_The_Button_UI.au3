...
Func _TheButton_UI_Create()
	...
	$aTheButtonUI[$idBtnTheButtonColorWHITE] = GUICtrlCreateButton("&WHITE", 124, 119, 81, 33)
	GUICtrlSetOnEvent(-1, "_TheButton_EventHandler")
	GUICtrlSetBkColor(-1, 0xFFFFFF)
	GUICtrlSetColor(-1, 0x000000)
	GUICtrlSetCursor(-1, 0)
	$aTheButtonUI[$idBtnTheButtonColorBLUE] = GUICtrlCreateButton("&BLUE", 124, 159, 81, 33)
	GUICtrlSetOnEvent(-1, "_TheButton_EventHandler")
	GUICtrlSetColor(-1, 0xFFFFFF)
	GUICtrlSetBkColor(-1, 0x0000FF)
	GUICtrlSetCursor(-1, 0)
	$aTheButtonUI[$idBtnTheButtonColorYELLOW] = GUICtrlCreateButton("&YELLOW", 124, 199, 81, 33)
	GUICtrlSetOnEvent(-1, "_TheButton_EventHandler")
	GUICtrlSetBkColor(-1, 0xFFFF00)
	GUICtrlSetCursor(-1, 0)
	$aTheButtonUI[$idBtnTheButtonColorRED] = GUICtrlCreateButton("&RED", 124, 239, 81, 33)
	GUICtrlSetOnEvent(-1, "_TheButton_EventHandler")
	GUICtrlSetColor(-1, 0xFFFFFF)
	GUICtrlSetBkColor(-1, 0xFF0000)
	GUICtrlSetCursor(-1, 0)
	$aTheButtonUI[$idBtnTheButtonTextPRESS] = GUICtrlCreateButton("&PRESS", 404, 119, 81, 33)
	GUICtrlSetOnEvent(-1, "_TheButton_EventHandler")
	GUICtrlSetCursor(-1, 0)
	$aTheButtonUI[$idBtnTheButtonTextHOLD] = GUICtrlCreateButton("&HOLD", 404, 159, 81, 33)
	GUICtrlSetOnEvent(-1, "_TheButton_EventHandler")
	GUICtrlSetCursor(-1, 0)
	$aTheButtonUI[$idBtnTheButtonTextDETONATE] = GUICtrlCreateButton("&DETONATE", 404, 199, 81, 33)
	GUICtrlSetOnEvent(-1, "_TheButton_EventHandler")
	GUICtrlSetCursor(-1, 0)
	$aTheButtonUI[$idBtnTheButtonTextABORT] = GUICtrlCreateButton("&ABORT", 404, 239, 81, 33)
	GUICtrlSetOnEvent(-1, "_TheButton_EventHandler")
	GUICtrlSetCursor(-1, 0)
	$aTheButtonUI[$idBtnTheButtonIndicatorBLUE] = GUICtrlCreateButton("&BLUE", 268, 143, 81, 33)
	GUICtrlSetOnEvent(-1, "_TheButton_EventHandler")
	GUICtrlSetColor(-1, 0xFFFFFF)
	GUICtrlSetBkColor(-1, 0x0000FF)
	GUICtrlSetCursor(-1, 0)
	GUICtrlSetState(-1, $GUI_HIDE)
	$aTheButtonUI[$idBtnTheButtonIndicatorYELLOW] = GUICtrlCreateButton("&YELLOW", 268, 183, 81, 33)
	GUICtrlSetOnEvent(-1, "_TheButton_EventHandler")
	GUICtrlSetBkColor(-1, 0xFFFF00)
	GUICtrlSetCursor(-1, 0)
	GUICtrlSetState(-1, $GUI_HIDE)
	$aTheButtonUI[$idBtnTheButtonIndicatorOTHER] = GUICtrlCreateButton("&OTHER", 268, 223, 81, 33)
	GUICtrlSetOnEvent(-1, "_TheButton_EventHandler")
	GUICtrlSetCursor(-1, 0)
	GUICtrlSetState(-1, $GUI_HIDE)
	...
	GUICtrlSetBkColor(-1, 0xFFFFFF)
	$aTheButtonUI[$idBtnTheButtonReset] = GUICtrlCreateButton("Reset (Esc)", 504, 48, 73, 25)
	GUICtrlSetOnEvent(-1, "_TheButton_EventHandler")
	GUICtrlSetCursor(-1, 0)
