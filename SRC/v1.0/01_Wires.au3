...
Func _Wires_EvaluateFourWireSequence()
	...
	If StringLeft($sWiresWireSequence,1) = "B" Then Return "Cut the 1st Wire"																;Blue count = 1, Cut 1st Wire
...
Func _Wires_EvaluateSixWireSequence()
	...
	If StringLen(StringReplace($sWiresWireSequence,"Y","")) = 5 And StringLen(StringReplace($sWiresWireSequence, "W", "")) < 5 Then Return "Cut the 4th Wire"		;Yellow count = 1 and White count > 1, Cut 4th Wire
