...
Func _Mazes_UI_Create()
	...
	GUICtrlCreateGroup("Enter Coordinates of one of the Green Circles then Help Navigate", 64, 72, 481, 331, -1, $WS_EX_TRANSPARENT)
	GUICtrlSetFont(-1, 11, 400, 0, "Calibri")
	GUICtrlSetBkColor(-1, 0xFFFFFF)
	GUICtrlCreateLabel("Column:", 184, 96, 69, 27)
	GUICtrlSetFont(-1, 14, 800, 0, "Calibri")
	$aMazesUI[$idComboMazesColumn] = GUICtrlCreateCombo("", 256, 96, 41, 25, BitOR($CBS_DROPDOWNLIST,$CBS_AUTOHSCROLL))
	GUICtrlSetOnEvent(-1, "_Mazes_EventHandler")
	GUICtrlCreateLabel("Row:", 336, 96, 44, 27)
	GUICtrlSetFont(-1, 14, 800, 0, "Calibri")
	$aMazesUI[$idComboMazesRow] = GUICtrlCreateCombo("", 384, 96, 41, 26, BitOR($CBS_DROPDOWNLIST,$CBS_AUTOHSCROLL))
	GUICtrlSetOnEvent(-1, "_Mazes_EventHandler")
	$aMazesUI[$idPicMazes] = GUICtrlCreatePic("", 178, 130, 260, 260, BitOR($GUI_SS_DEFAULT_PIC,$SS_CENTERIMAGE,$WS_BORDER))
	GUICtrlCreateGroup("", -99, -99, 1, 1)
	$aMazesUI[$idBtnMazesReset] = GUICtrlCreateButton("Reset (Esc)", 504, 48, 73, 25)
	GUICtrlSetOnEvent(-1, "_Mazes_EventHandler")
