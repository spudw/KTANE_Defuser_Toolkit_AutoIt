...
Func _Keypads_UI_Create()
	...
	GUICtrlCreateGroup("Which Symbols are Displayed", 172, 72, 465, 227, -1, $WS_EX_TRANSPARENT)
	GUICtrlSetFont(-1, 11, 400, 0, "Calibri")
	GUICtrlSetBkColor(-1, 0xFFFFFF)
	$aKeypadsUI[$idBtnKeypadsSymbol0] = _Keypads_UI_Create_Button("¿", 196, 102, 33, 33)
	$aKeypadsUI[$idBtnKeypadsSymbol1] = _Keypads_UI_Create_Button("©", 260, 102, 33, 33)
	$aKeypadsUI[$idBtnKeypadsSymbol2] = _Keypads_UI_Create_Button("¶", 324, 102, 33, 33)
	$aKeypadsUI[$idBtnKeypadsSymbol3] = _Keypads_UI_Create_Button("☆", 388, 102, 33, 33, 20)
	$aKeypadsUI[$idBtnKeypadsSymbol4] = _Keypads_UI_Create_Button("★", 452, 102, 33, 33, 20)
	$aKeypadsUI[$idBtnKeypadsSymbol5] = _Keypads_UI_Create_Button("҂", 516, 102, 33, 33)
	$aKeypadsUI[$idBtnKeypadsSymbol6] = _Keypads_UI_Create_Button("ƛ", 580, 102, 33, 33)
	$aKeypadsUI[$idBtnKeypadsSymbol7] = _Keypads_UI_Create_Button("ͼ", 196, 150, 33, 33, 20)
	$aKeypadsUI[$idBtnKeypadsSymbol8] = _Keypads_UI_Create_Button("ͽ", 260, 150, 33, 33, 20)
	$aKeypadsUI[$idBtnKeypadsSymbol9] = _Keypads_UI_Create_Button("ψ", 324, 150, 33, 33)
	$aKeypadsUI[$idBtnKeypadsSymbol10] = _Keypads_UI_Create_Button("Ω", 388, 150, 33, 33)
	$aKeypadsUI[$idBtnKeypadsSymbol11] = _Keypads_UI_Create_Button("Ϟ", 452, 150, 33, 33)
	$aKeypadsUI[$idBtnKeypadsSymbol12] = _Keypads_UI_Create_Button("Ϙ", 516, 150, 33, 33)
	$aKeypadsUI[$idBtnKeypadsSymbol13] = _Keypads_UI_Create_Button("ϗ", 580, 150, 33, 33)
	$aKeypadsUI[$idBtnKeypadsSymbol14] = _Keypads_UI_Create_Button("б", 196, 198, 33, 33)
	$aKeypadsUI[$idBtnKeypadsSymbol15] = _Keypads_UI_Create_Button("Җ", 260, 198, 33, 33)
	$aKeypadsUI[$idBtnKeypadsSymbol16] = _Keypads_UI_Create_Button("ҋ", 324, 198, 33, 33)
	$aKeypadsUI[$idBtnKeypadsSymbol17] = _Keypads_UI_Create_Button("Ҩ", 388, 198, 33, 33)
	$aKeypadsUI[$idBtnKeypadsSymbol18] = _Keypads_UI_Create_Button("Ҍ", 452, 198, 33, 33, 20)
	$aKeypadsUI[$idBtnKeypadsSymbol19] = _Keypads_UI_Create_Button("Ӭ", 516, 198, 33, 33)
	$aKeypadsUI[$idBtnKeypadsSymbol20] = _Keypads_UI_Create_Button("Ѧ", 580, 198, 33, 33)
	$aKeypadsUI[$idBtnKeypadsSymbol21] = _Keypads_UI_Create_Button("Ѭ", 228, 246, 33, 33)
	$aKeypadsUI[$idBtnKeypadsSymbol22] = _Keypads_UI_Create_Button("Ѯ", 292, 246, 33, 33)
	$aKeypadsUI[$idBtnKeypadsSymbol23] = _Keypads_UI_Create_Button("Ѽ", 356, 246, 33, 33)
	$aKeypadsUI[$idBtnKeypadsSymbol24] = _Keypads_UI_Create_Button("ӕ", 420, 246, 33, 33)
	$aKeypadsUI[$idBtnKeypadsSymbol25] = _Keypads_UI_Create_Button("Ԇ", 484, 246, 33, 33)
	$aKeypadsUI[$idBtnKeypadsSymbol26] = _Keypads_UI_Create_Button("ټ", 548, 246, 33, 33, 20)
	GUICtrlCreateGroup("", -99, -99, 1, 1)
	$aKeypadsUI[$idLblKeypadsSolution] = GUICtrlCreateLabel("", 172, 303, 465, 37, $SS_CENTER)
	GUICtrlSetFont(-1, 20, 400, 4, "Calibri")
	GUICtrlSetBkColor(-1, 0xFFFFFF)
	$aKeypadsUI[$idBtnKeypadsSolution1] = GUICtrlCreateButton("", 256, 346, 33, 33)
	GUICtrlSetFont(-1, 18, 400, 0, "Arial")
	$aKeypadsUI[$idBtnKeypadsSolution2] = GUICtrlCreateButton("", 344, 346, 33, 33)
	GUICtrlSetFont(-1, 18, 400, 0, "Arial")
	$aKeypadsUI[$idBtnKeypadsSolution3] = GUICtrlCreateButton("", 432, 346, 33, 33)
	GUICtrlSetFont(-1, 18, 400, 0, "Arial")
	$aKeypadsUI[$idBtnKeypadsSolution4] = GUICtrlCreateButton("", 520, 346, 33, 33)
	GUICtrlSetFont(-1, 18, 400, 0, "Arial")
	GUICtrlCreateLabel("1", 263, 381, 15, 30, $SS_CENTER)
	GUICtrlSetFont(-1, 16, 400, 0, "Calibri")
	GUICtrlSetBkColor(-1, 0xFFFFFF)
	GUICtrlCreateLabel("2", 353, 380, 15, 30, $SS_CENTER)
	GUICtrlSetFont(-1, 16, 400, 0, "Calibri")
	GUICtrlSetBkColor(-1, 0xFFFFFF)
	GUICtrlCreateLabel("3", 441, 381, 15, 30, $SS_CENTER)
	GUICtrlSetFont(-1, 16, 400, 0, "Calibri")
	GUICtrlSetBkColor(-1, 0xFFFFFF)
	GUICtrlCreateLabel("4", 529, 381, 15, 30, $SS_CENTER)
	GUICtrlSetFont(-1, 16, 400, 0, "Calibri")
	GUICtrlSetBkColor(-1, 0xFFFFFF)
	$aKeypadsUI[$idBtnKeypadsReset] = GUICtrlCreateButton("Reset (Esc)", 700, 48, 73, 25)
