...
Func _ComplicatedWires_UI_Create()
	...
	GUICtrlCreateGroup("Enter the Details of Each Wire", 164, 112, 481, 147, -1, $WS_EX_TRANSPARENT)
	GUICtrlSetFont(-1, 11, 400, 0, "Calibri")
	GUICtrlSetBkColor(-1, 0xFFFFFF)
	$aComplicatedWiresUI[$idBtnComplicatedWiresRED] = GUICtrlCreateButton("&RED", 272, 136, 81, 33)
	GUICtrlSetOnEvent(-1, "_ComplicatedWires_EventHandler")
	GUICtrlSetColor(-1, 0xFFFFFF)
	GUICtrlSetBkColor(-1, 0xFF0000)
	GUICtrlSetCursor(-1, 0)
	$aComplicatedWiresUI[$idBtnComplicatedWiresBLUE] = GUICtrlCreateButton("&BLUE", 272, 176, 81, 33)
	GUICtrlSetOnEvent(-1, "_ComplicatedWires_EventHandler")
	GUICtrlSetColor(-1, 0xFFFFFF)
	GUICtrlSetBkColor(-1, 0x0000FF)
	GUICtrlSetCursor(-1, 0)
	$aComplicatedWiresUI[$idBtnComplicatedWiresLED] = GUICtrlCreateButton("&LED", 456, 136, 81, 33)
	GUICtrlSetOnEvent(-1, "_ComplicatedWires_EventHandler")
	GUICtrlSetCursor(-1, 0)
	$aComplicatedWiresUI[$idBtnComplicatedWiresSTAR] = GUICtrlCreateButton("&STAR", 456, 176, 81, 33)
	GUICtrlSetOnEvent(-1, "_ComplicatedWires_EventHandler")
	GUICtrlSetCursor(-1, 0)
	$aComplicatedWiresUI[$idBtnComplicatedWiresSubmit] = GUICtrlCreateButton("Submit", 356, 224, 97, 25, $GUI_SS_DEFAULT_BUTTON)
	GUICtrlSetOnEvent(-1, "_ComplicatedWires_EventHandler")
	GUICtrlSetFont(-1, 16, 400, 4, "Calibri")
	GUICtrlCreateGroup("", -99, -99, 1, 1)
	$aComplicatedWiresUI[$idLblComplicatedWiresSolution] = GUICtrlCreateLabel("", 144, 271, 501, 37, $SS_CENTER)
	GUICtrlSetFont(-1, 16, 400, 4, "Calibri")
	GUICtrlSetBkColor(-1, 0xFFFFFF)
	$aComplicatedWiresUI[$idBtnComplicatedWiresReset] = GUICtrlCreateButton("Reset (Esc)", 700, 48, 73, 25)
	GUICtrlSetOnEvent(-1, "_ComplicatedWires_EventHandler")
	GUICtrlSetCursor(-1, 0)
