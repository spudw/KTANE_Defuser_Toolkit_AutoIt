...
Func _Memory_UI_Create()
	...
	GUICtrlCreateGroup("Enter the Numbers Displayed", 164, 104, 481, 163, -1, $WS_EX_TRANSPARENT)
	GUICtrlSetFont(-1, 11, 400, 0, "Calibri")
	GUICtrlSetBkColor(-1, 0xFFFFFF)
	GUICtrlCreateLabel("Display #", 366, 128, 81, 30, $SS_CENTER)
	GUICtrlSetFont(-1, 16, 800, 0, "Calibri")
	$aMemoryUI[$idInputMemoryDisplayNumber] = GUICtrlCreateInput("", 316, 160, 177, 41, BitOR($ES_CENTER, $ES_NUMBER))
	GUICtrlSetFont(-1, 20, 800, 0, "Calibri")
	GUICtrlSetColor(-1, 0xFFFFFF)
	GUICtrlSetBkColor(-1, 0x000000)
	GUICtrlSetLimit(-1, 1, 0)
	$aMemoryUI[$idInputMemoryNumber1] = GUICtrlCreateInput("", 316, 216, 33, 31, BitOR($ES_CENTER, $ES_NUMBER))
	GUICtrlSetFont(-1, 14, 400, 0, "Calibri")
	GUICtrlSetLimit(-1, 1, 0)
	$aMemoryUI[$idInputMemoryNumber2] = GUICtrlCreateInput("", 364, 216, 33, 31, BitOR($ES_CENTER, $ES_NUMBER))
	GUICtrlSetFont(-1, 14, 400, 0, "Calibri")
	GUICtrlSetLimit(-1, 1, 0)
	$aMemoryUI[$idInputMemoryNumber3] = GUICtrlCreateInput("", 412, 216, 33, 31, BitOR($ES_CENTER, $ES_NUMBER))
	GUICtrlSetFont(-1, 14, 400, 0, "Calibri")
	GUICtrlSetLimit(-1, 1, 0)
	$aMemoryUI[$idInputMemoryNumber4] = GUICtrlCreateInput("", 460, 216, 33, 31, BitOR($ES_CENTER, $ES_NUMBER))
	GUICtrlSetFont(-1, 14, 400, 0, "Calibri")
	GUICtrlCreateGroup("", -99, -99, 1, 1)
	$aMemoryUI[$idLblMemorySolution] = GUICtrlCreateLabel("Stage 1", 164, 271, 481, 37, $SS_CENTER)
	GUICtrlSetFont(-1, 20, 400, 4, "Calibri")
	GUICtrlSetBkColor(-1, 0xFFFFFF)
	$aMemoryUI[$idBtnMemorySubmit] = GUICtrlCreateButton("Submit", 356, 324, 97, 25, $GUI_SS_DEFAULT_BUTTON)
	GUICtrlSetOnEvent(-1, "_Memory_EventHandler")
	GUICtrlSetFont(-1, 16, 400, 4, "Calibri")
	$aMemoryUI[$idBtnMemoryReset] = GUICtrlCreateButton("Reset (Esc)", 700, 48, 73, 25)
	GUICtrlSetOnEvent(-1, "_Memory_EventHandler")
